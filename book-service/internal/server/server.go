...
import (
	...
	api "github.com/daniil4142/book-market/book-service/internal/app/book-service"
...
func NewGrpcServer(bookService *book_service.Service) *GrpcServer {
	return &GrpcServer{
...
func (s *GrpcServer) Start(cfg *config.Config) error {
	...
	desc.RegisterBookServiceServer(grpcServer, api.NewBookService(s.bookService))
